						...
						<div class="container">
							<div class="row">
								...
								<div class="col-12 col-sm-6">
									...
									<?php
// Check if $frow is not null and if 'fname' exists in it
if ($frow !== null && isset($frow['fname'])) {
    echo '<p style="font: 30px Times new roman;">Product Owner : ' . $frow['fname'] . '</p>';
} else {
    // Handle the case where $frow is null or 'fname' does not exist
    echo '<p style="font: 30px Times new roman;">Product Owner not available</p>';
}
?>
